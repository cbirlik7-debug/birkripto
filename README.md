...
Veritabanı migration dosyalarını Supabase SQL Editor'da sırayla çalıştırın. `0004_bot_cycle_idempotency.sql` ile `0011_trade_details.sql` arasındaki migration dosyaları uygulanmalıdır.
